          ...
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="px-4 py-2 bg-brand-red text-white text-sm font-semibold rounded-lg hover:bg-brand-navy-dark transition-colors"
              >
                Mark All Read
              </button>
            )}
                    ...
                    <div className="flex-1">
                      ...
                      {notification.link && (
                        <Link
                          ...
                          className="inline-block mt-2 text-sm text-brand-navy-dark hover:text-brand-red font-semibold"
                        >
                          View →
                        </Link>
                      )}
